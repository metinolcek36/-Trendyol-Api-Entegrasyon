...
class Trendyol {
    function __construct() {
        //$CI = get_instance();
        $this->supplierId = '195881';
        $this->username = '9BP2miTrFWx6LVKU2UTD';
        $this->password = 'zmqsE1lAxwWLMkepFYu7';
    ...
    */
    public function getProductsWithBatchRequest($batchRequest) {
        ...
        $response = $this->guzzle->get($url);
        //https://api.trendyol.com/sapigw/suppliers/%7Bsupplierid%7D/products/batch-requests/%7BbatchRequestId%7D
        return $response->getBody();
    }
    ...
    */
    public function updateProduct($item, $type) {
        ...
        elseif ($type == "update") {
            ...
            //$response = $guzzle->send($request,['timeout'=>2]);
        }
        return $response->getBody();
    }
